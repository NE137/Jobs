...
import me.n137.Jobs.gui.jobsadmin.JobSelectorForHireMenu;
...
public class PlayerHireSelectorMenu extends PaginatedMenu {


    public PlayerHireSelectorMenu(PlayerMenuUtility playerMenuUtility) {
    ...
    public void handleMenu(InventoryClickEvent e) {
        ...
        if (e.getCurrentItem().getType().equals(Material.PLAYER_HEAD)) {
            ...
            new JobSelectorForHireMenu(playerMenuUtility).open();
