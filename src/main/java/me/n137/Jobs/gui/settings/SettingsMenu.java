...
public class SettingsMenu extends PaginatedMenu {
    ...
    public void handleMenu(InventoryClickEvent e) {
        ...
        switch (e.getCurrentItem().getType()) {
            case BOOK:
                e.getWhoClicked().sendMessage("§cThis feature is not finished yet. Please wait...");
    ...
    public void setMenuItems() {
        inventory.setItem(10, Jobs.getPlugin().getMenuHandler().createMenuItem(Material.BOOK, "messages.menuitem.admin.max_jobs", Arrays.asList("§r", "§e● §7Change the maximum amount of jobs a player can have.", "§r")));
      ...
      /*
      max_jobs: "&7Change Maximum Jobs"
      toggle_earnings: "&aToggle Randomized Earnings"
      toggle_income: "&cToggle Randomized Earnings"
      toggle_verbose: "&eToggle Verbose Mode"
      reload_configs: "&dReload Configuration"
      return: "&cReturn"
      */
    }
}